export const site = {
  ...
  github: 'https://github.com/agimenezromero',
  scholar: 'https://scholar.google.es/citations?user=KurxXPAAAAAJ&hl=en',
  bluesky: 'https://bsky.app/profile/agimenezromero.bsky.social',
};

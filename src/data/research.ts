...
export const researchThemes: ResearchTheme[] = [
  {
    ...
    publicationKeys: [
      'GimenezRomero2026_networks',
      'GimenezRomero2026_demographic',
      'GimenezRomero2025',
      'Oro2026',
      'qi2026density',
    ],

    imagePrefix: 'ecological-structure',

    imageAlt:
      'Research on ecological stability and resilience',
  },
...

  {
    ...
    publicationKeys: [
      'RodriguezCabanillas2026',
      'Giménez-Romero2025_high_resolution',
      'GimenezRomero2023_PD',
      'Moralejo2024',
      'GimenezRomero2023',
      'GimenezRomero2022_CommsBio',
    ],

    imagePrefix: 'disease',

    imageAlt:
      'Research on climate-driven disease dynamics and epidemic risk',
  },
...

  {
    ...
    publicationKeys: [
      'GimenezRomero2026_inferring',
      'GimenezRomero2026_intermittent',
      'Llabrés2026',
      'GimenezRomero2026_thermal',
      'Gimenez-Romero2024_corals',
    ],

    imagePrefix: 'spatial-patterns',

    imageAlt:
      'Research on spatial organization and pattern formation in ecological systems',
  },
...

  {
    ...
    publicationKeys: [
      'GimenezRomero2025_posi',
      'Flecha2022',
    ],

    imagePrefix: 'ecological-observation',

    imageAlt:
      'Research on ecological remote sensing and artificial intelligence',
  },
];